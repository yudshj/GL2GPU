...
var WebGLSprite = (function() {
    ...
    function createQuadBuffer(gl, quad_count) {
        ...
        var pos_size = vert_count * 2 * Float32Array.BYTES_PER_ELEMENT;
        var attr_size = 0;

        quad_buffer.streams.push(createStream(gl, 2, gl.FLOAT, false, 0, 0, 0));
        ...
        var verts = new Float32Array(quad_count * 8);

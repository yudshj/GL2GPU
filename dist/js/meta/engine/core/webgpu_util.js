...
var WebGLUtil = (function() {
    ...
    async function createBareContext(canvas, attribs) {
    ...
    async function createContext(canvas, attribs) {
      var gl_context = await WebGLUtil.createBareContext(canvas, attribs);
      if (!gl_context) {
        return null;
      }
